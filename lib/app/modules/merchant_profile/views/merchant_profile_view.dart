...
import 'merchant_shop_view.dart';
        ...
        Positioned(
          ...
          child: Row(
            ...
            children: [
              GestureDetector(
                onTap: () {
                  Share.share('Check out this merchant profile on Glotune!');
                },
                child: Row(
                  children: [
                    Icon(Icons.shortcut, color: Colors.white, size: 20.sp),
                    SizedBox(width: 4.w),
                    Text(
                      "Share Profile",
                      style: TextStyle(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: const LinearGradient(
          colors: [Color(0xFF7B2CBF), Color(0xFFC77DFF)], // Purple gradient
