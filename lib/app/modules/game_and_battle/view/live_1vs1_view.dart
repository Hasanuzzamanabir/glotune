...
class LiveBattle1v1View extends GetView<CreateController> {
            ...
            children: [
              Expanded(
                child: Container(
                  ...
                  child: _buildParticipantOverlay("Jasmine 🔥🔥", "100"),
                ),
              ),
              Container(width: 1.5.w, color: Colors.white24),
              Expanded(
                child: Container(
                  decoration: const BoxDecoration(
                    image: DecorationImage(
                  ...
                  child: _buildParticipantOverlay("Usman 🥊🥊", "500"),
                ),
              ),
            ],
          ),
  ...
  Widget _buildParticipantOverlay(String name, String points) {
    return Stack(
      children: [
        Positioned(
          bottom: 40.h,
          ...
          child: Container(
            ...
            child: Row(
              children: [
                Text(name, style: TextStyle(color: Colors.white, fontSize: 10.sp, fontWeight: FontWeight.bold)),
                SizedBox(width: 4.w),
          ...
          child: Row(
            children: [
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    SizedBox(width: 2.w),
                    Text(points, style: TextStyle(color: Colors.white, fontSize: 10.sp)),
                  ],
                ),
              ),
              SizedBox(width: 6.w),
              SizedBox(
                ...
                child: Row(
                  children: [
                    CircleAvatar(radius: 8.r, backgroundImage: const AssetImage('assets/images/user_avatar.png')),
                    SizedBox(width: 2.w),
                    CircleAvatar(radius: 8.r, backgroundImage: const AssetImage('assets/images/user_avatar.png')),
                  ],
                ),
