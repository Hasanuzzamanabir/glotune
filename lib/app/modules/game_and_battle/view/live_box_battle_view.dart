...
class LiveBoxBattleView extends GetView<CreateController> {
  ...
  Widget _buildBoxBattleMainSection() {
    return SizedBox(
      height: 340.h,
      child: Row(
        children: [
          // Left: Host Video + Host Pill + Red 1:30 Timer Pill
          Expanded(
            flex: 5,
            child: Stack(
              fit: StackFit.expand,
              children: [
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: Text("Host", style: TextStyle(color: Colors.white, fontSize: 10.sp, fontWeight: FontWeight.bold)),
                  ),
                ),
                Positioned(
                  top: 8.h,
                  ...
                  child: Container(
                    ...
                    child: Text("1:30", style: TextStyle(color: Colors.white, fontSize: 10.sp, fontWeight: FontWeight.bold)),
                  ),
                ),
              ],
            ),
        ...
        children: [
          Positioned(
            ...
            child: Container(
              ...
              child: Text(score, style: TextStyle(color: Colors.amberAccent, fontSize: 7.sp, fontWeight: FontWeight.bold)),
            ),
          ),
          Positioned(
            bottom: 2.h,
