...
import '../../merchant_profile/bindings/merchant_profile_binding.dart';
import '../../merchant_profile/views/merchant_shop_view.dart';
import '../controllers/content_creator_profile_controller.dart';
import '../../profile/controllers/profile_controller.dart';

class ContentCreatorProfileView
    extends GetView<ContentCreatorProfileController> {
          ...
          child: Row(
            ...
            children: [
              GestureDetector(
                onTap: () {
                  Share.share(
                    'Check out this content creator profile on Glotune!',
                  );
                },
                child: Row(
                  children: [
    ...
    return Column(
      children: [
        _buildMenuItem(
          ...
          onTap: () => Get.toNamed(Routes.AFFILIATE_PROGRAM),
        ),
        _buildMenuDivider(),
        _buildMenuItem(
          Icons.receipt_long,
          "Affiliate tools",
          "View all past videos watched",
          onTap: () => Get.toNamed(Routes.AFFILIATE_TOOLS),
        ),
        _buildMenuDivider(),
        _buildMenuItem(
          Icons.receipt_long,
        ...
        _buildMenuItem(
          ...
          "Videos statistics",
          "View all past videos watched",
          onTap: () => Get.toNamed(Routes.VIDEO_STATISTICS),
        ),
        _buildMenuDivider(),
        _buildMenuItem(
          Icons.business_center,
          "Information center",
          "Manage request",
          onTap: () => Get.toNamed(Routes.INFORMATION_CENTER),
        ),
        _buildMenuDivider(),
        Obx(
          () => _buildMenuItem(
            Icons.receipt_long,
            "Manage by talent manager",
            "Allow creators send an invite",
            showSwitch: true,
            switchValue: controller.isManagedByTalentManager.value,
            onSwitchChanged: controller.toggleTalentManager,
          ),
        ),
      ],
    );
